...
parser.add_argument('--exp_name', type=str, default=EXPNAME, metavar='N',
                    help='Name of the experiment')
parser.add_argument('--batch_size', type=int, default=100, metavar='batch_size',
                    help='Size of batch)')#10
...
parser.add_argument('--decay_interval', type=int, default=10000, metavar='N',
                    help='Learning rate decay interval')#10000
parser.add_argument('--lr', type=float, default=0.001, metavar='LR',
                    help='learning rate (default: 0.01)')#0.001
...
parser.add_argument('--save_interval', type=int, default=300000, metavar='N',
                    help='how many batches between each model saving')#300000
...
parser.add_argument('--dec_lr', type=int, default=15000, metavar='N',
                    help='Decreasing the learning rate every x iterations')#10000
...
def train():
    ...
    writer.add_scalar("train_loss", total_loss / counter, batch_idx)
